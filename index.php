...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <div id="preloader">
		<div class="preloader pulse">
			<h3>Grace Balogun & Oluwafemi Ifesanmi</h3>
		</div>
    </div><!-- end loader -->
    <!-- END LOADER -->
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 text-center">
						<div class="title-box">
							<h2>Oluwafemi Ifesanmi <span> & </span> Grace Balogun </h2>
						</div>
					</div>
				</div>
				<div class="row">
						...
						<div class="row align-items-center about-main-info">
							<div class="col-lg-4 col-md-6 col-sm-12">
								<div class="about-m">
									...
									<ul>
										<li><a href="https://www.facebook.com/oxenads"><i class="fa fa-facebook"></i></a></li>
										<li><a href="https://x.com/yembal29"><i class="fa fa-twitter"></i></a></li>
										<li><a href="https://www.instagram.com/oxenads/"><i class="fa fa-instagram"></i></a></li>
									</ul>
								</div>
							</div>
						...
						<div class="row align-items-center about-main-info">
							<div class="col-lg-4 col-md-6 col-sm-12">
								<div class="about-m">
									...
									<ul>
										<li><a href="https://www.facebook.com/Ifesanmi.OLUWAFEMl"><i class="fa fa-facebook"></i></a></li>
										<li><a href="https://x.com/OIfesanmi"><i class="fa fa-twitter"></i></a></li>
										<li><a href="https://www.linkedin.com/in/oluwafemi-ifesanmi/"><i class="fa fa-linkedin"></i></a></li>
									</ul>
								</div>
							</div>
							<div class="col-lg-8 col-md-6 col-sm-12">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 item" >
						<div class="caption">
							...
							<div class="image">
								...
								<div class="title">
									<h2>Click Here <i class="fa fa-angle-right" aria-hidden="true"></i></h2>
								</div>
							</div>
			...
			<div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="serviceBox">
                        ...
                        <h3 class="title">Engagement Ceremony </h3>
						<h4><b>7:00 am</b> on the 26 December 2024</h4>
                        <p class="description">
                            Behind the Bride's Family house. Batex Engagement Center, Ijigba last Bustop, Oda Road Akure; Ondo State, Nigeria.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="serviceBox">
						...
						<h4><b>10:00 am</b> on the 26 December 2024</h4>
                        <p class="description">
                            Apostolic Faith Church. Opp St. Michael Catholic Secondary School, Off Ijoka Rd. Akure; Ondo State, Nigeria.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="serviceBox">
						...
						<h4><b>After Church Service</b></h4>
                        <p class="description">
                            Behind the Bride's Family house. Batex Engagement Center, Ijigba last Bustop, Oda Road Akure; Ondo State, Nigeria.
                        </p>
                    </div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="title-box">
						<h2>Gift Registry</h2>
						<p>We can’t wait to celebrate our union with you! We have been overwhelmed with generosity since our engagement party. For this reason, we politely request no wedding gifts.
							<br>
							A wishing well will be available at our wedding if you'd like to help us celebrate
	...
	<footer class="footer-box">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<p class="footer-company-name">All Rights Reserved. &copy; 2018 <a href="#">The Benediction</a> Design By : <a href="https://html.design/">html design</a></p>
				</div>
			</div>
		</div>
	</footer>
